...
# Shiny UI
ui <- fluidPage(
    titlePanel("Weather and Google Search Trends"),

    sidebarLayout(
        sidebarPanel(
            selectInput("cityInput", "Choose a City:", choices = unique(mich_df$city)),
            sliderInput("weekInput", "Select Week:", min = 1, max = 52, value = 1)
        ),
