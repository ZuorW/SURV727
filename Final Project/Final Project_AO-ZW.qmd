...
lansing_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               ...
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(lansing_trends$interest_over_time, "SADtrends_Lansing.csv") # save as csv

alpena_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               geo = "US-MI-583",  
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(alpena_trends$interest_over_time, "SADtrends_Alpena.csv") # save as csv

flint_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               geo = "US-MI-513",  
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(flint_trends$interest_over_time, "SADtrends_Flint-Saginaw-BayCity.csv") # save as csv

gr_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               geo = "US-MI-563",  
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(gr_trends$interest_over_time, "SADtrends_GrandRapids-Kalamazoo-BattleCreek.csv") # save as csv

marq_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               geo = "US-MI-553",  
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(marq_trends$interest_over_time, "SADtrends_Marquette.csv") # save as csv

trav_trends <- gtrends(c("light therapy", "seasonal affective disorder", "winter blues"), 
               geo = "US-MI-540",  
               time = "2017-12-01 2023-12-01", 
               low_search_volume = TRUE)
write.csv(trav_trends$interest_over_time, "SADtrends_Traverse City-Cadillac.csv") # save as csv
```
