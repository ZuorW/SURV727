...
response <- VERB("GET", url, query = queryString, add_headers('X-RapidAPI-Key' = '0712967ff5msh61d3d913f017517p1ecf1bjsn0e2146cddb57', 'X-RapidAPI-Host' = 'billboard-api2.p.rapidapi.com'), content_type("application/octet-stream"))
